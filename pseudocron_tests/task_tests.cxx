...
static const std::string sc_strNoFracs = "5 14 3 echo blah";
...
{
    const unsigned c_uMin = extractMinutesVal(sc_strNoFracs);
...
{
    const unsigned c_uHr = extractHoursVal(sc_strNoFracs);
...
{
    const unsigned c_uDy = extractDaysVal(sc_strNoFracs);
...
{
    const std::string strCmd = extractCmd(sc_strNoFracs);
